            ...
            <Card
              ...
              <Card.Body>
                <Link
                  ...
                  <Card.Subtitle className=" d-flex justify-content-center align-items-center smMT">
                    {product.name}
                  </Card.Subtitle>
                </Link>
                {/* <hr /> */}
                <h3></h3>
                <Card.Subtitle className="d-flex justify-content-center align-items-center smMB">
                  ${product.price}
                </Card.Subtitle>
                <hr />
                {user ? (
