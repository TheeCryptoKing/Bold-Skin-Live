  ...
  return (
    <div>
      {!useAddressOnRecord && addressDetails && addressDetails.length > 0 && (
        <div>
          <h3 className="mdMT mdMB title-text">
            Would you like to use an address on record?
          </h3>
          ...
          <Formik
            ...
            {({ handleSubmit }) => (
              <Form onSubmit={handleSubmit} className=" mdMT">
                <Form.Group controlId="address_1" className=" mdMT">
        ...
        <Formik
          ...
          {({ handleSubmit }) => (
            <Form onSubmit={handleSubmit}>
              <Form.Group controlId="address_1" className="address-form-input">
              ...
              <Form.Group controlId="address_2" className="address-form-input">
                <Form.Label>Address Line 2</Form.Label>
                <Field type="text" name="address_2" as={Form.Control} />
              </Form.Group>
              ...
              <Button type="submit" className="checkout-button mdMB ">
                Add Address
              </Button>
              <Button
                type="submit"
